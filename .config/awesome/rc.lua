...
local keyboardlayout = awful.widget.button { image = usIcon,   resize = false}
...
local keyboardlayoutIcon = wibox.widget {
	{
		forced_height = 20,
		forced_width  = 20,
...
{ "open terminal", terminal }
																...
																local function set_wallpaper(s)
																	...
																	if beautiful.wallpaper then
																		...
																		gears.wallpaper.maximized("/home/abbe/Pictures/wp.jpg", s, true)
																	end
																end
														...
														awful.key({modkey}, "y", function ()
															awful.util.spawn_with_shell("sleep 0.5 && scrot -u")
														end),
